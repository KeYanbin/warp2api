...
CONNECT_TIMEOUT = float(os.getenv("WARP_CONNECT_TIMEOUT", "30"))      # 连接超时
READ_TIMEOUT = float(os.getenv("WARP_READ_TIMEOUT", "300"))           # 读取超时（5分钟适合长SSE流）
WRITE_TIMEOUT = float(os.getenv("WARP_WRITE_TIMEOUT", "60"))          # 写入超时
POOL_TIMEOUT = float(os.getenv("WARP_POOL_TIMEOUT", "60"))            # 连接池超时
